...
const DEFAULT_ACCOUNTS: SharedAccountGroup[] = [
  {
    category: "광고",
    items: [
      { id: "a1", name: "메타(Meta)", loginId: "", password: "" },
      { id: "a2", name: "구글", loginId: "", password: "" },
      { id: "a3", name: "네이버", loginId: "", password: "" },
      { id: "a4", name: "카카오", loginId: "", password: "" },
      { id: "a5", name: "틱톡", loginId: "", password: "" },
    ],
  },
  {
    category: "디자인/AI",
    items: [
      { id: "b1", name: "어도비(Adobe)", loginId: "", password: "" },
      { id: "b2", name: "미리캔버스", loginId: "", password: "" },
      { id: "b3", name: "프리픽", loginId: "", password: "" },
      { id: "b4", name: "엔바토", loginId: "", password: "" },
      { id: "b5", name: "망고보드", loginId: "", password: "" },
      { id: "b6", name: "ChatGPT", loginId: "", password: "" },
    ],
  },
  {
    category: "경영/행정",
    items: [
      { id: "c1", name: "세무(홈택스)", loginId: "", password: "" },
      { id: "c2", name: "4대보험", loginId: "", password: "" },
      { id: "c3", name: "기업/국민은행", loginId: "", password: "" },
      { id: "c4", name: "노무사", loginId: "", password: "" },
      { id: "c5", name: "구글 워크스페이스", loginId: "", password: "" },
    ],
  },
  {
    category: "기타/호스팅",
    items: [
      { id: "d1", name: "카페24(Cafe24)", loginId: "", password: "" },
      { id: "d2", name: "가비아(Gabia)", loginId: "", password: "" },
      { id: "d3", name: "아임웹(Imweb)", loginId: "", password: "" },
    ],
  },
];
