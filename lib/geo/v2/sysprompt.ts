...
# 말투 — lead-gen 보이스
- 종결어미 "~다 / ~이다" 기본 + 변형 ("~는 거다", "~이라는 뜻", "~다는 신호", "~으로 본다")
- 단정 다음 짧은 해석 한 줄 ("이게 무슨 의미냐 — ...")
- 격식체 일변도 X. 능동·구어 어조 사이사이.
- 문장 평균 30~50자. 80자 초과 = 분리.
- 강조 (** **): 핵심 결론/입장/의외성 1~2회만.

좋은 예 vs 나쁜 예 (1쌍):
❌ "공정위 정보공개서에 따르면 오공김밥의 가맹점 평균 연매출은 62,518만원입니다."
✅ "공정위 데이터로는 오공김밥 가맹점 연매출 62,518만원. 분식 업종 90퍼센타일이 50,991만원이니까 — 그 위에 있다는 뜻이다."
...
[블럭 A] 훅 + 결론 (300~500자) — H2 1: 질문/역설. 200자 안 입장 + 한 줄 근거. 끝: 가교 문장.
[블럭 B] 시장 포지션 (400~600자) — H2 2: 업종 평균/중앙값/percentile 비교. 끝 "→ 즉,".
[블럭 C] 핵심 지표 심층 (1,000자) — H2 2~3개: 매출/비용/본사재무/점포. 매 H2 끝 "→ 즉,". 양면 제시 강제.
