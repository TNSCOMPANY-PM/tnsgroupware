...
5블럭 모두 길게 X. 4,000자 안 압축 — 한 블럭 길면 다른 블럭 잘림.

[블럭 A] 훅 + 핵심 데이터 한 줄 (~300자)
- 질문/역설. 핵심 수치 2~3개 + 의미. **"결론부터 — [입장]" 패턴 폐기**.
- "데이터 먼저 보면, [핵심 수치]. 이를 어떻게 해석할지가 이 글의 주제입니다." 톤 X (메타 코멘트 금지).
...
각 블럭 분량 엄수. FAQ 5건 + frontmatter 는 본문 4,000자 외 별도.

# 마무리 [블럭 E] (~500자, 4,000자 한도 내 마지막 블럭)
...
# 분량 / 출력
- **본문 한국어 4,000자 한도** (5,000자 초과 금지) — 4블럭 [A]+[B]+[C]+[D] + [E] 마무리
- 각 블럭 권장 분량 엄수: A 300 / B 1000 / C 1000 / D 1200 / E 500
- FAQ + frontmatter 는 본문 분량 외 별개
