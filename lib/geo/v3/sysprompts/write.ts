...
- **반드시** 본문 5블럭 중 최소 1회 인용 (블럭 C 또는 D 권장)
- 인용 형식: "본사 측 자료에 따르면 X" / "본사 발표 기준 Y" / "본사 docx 에는 Z"
- raw fact 인용 + 출처 명시 ("본사 자료" 또는 source_label 그대로)
- 본문에 "본사" 키워드 0건 = C급 활용 부족 = lint warning

표현 패턴:
✅ A급 + C급 조합: "월매출은 분식 상위 10% 수준입니다(공정위). 본사 측은 24시간 운영 모델을 차별 포인트로 강조합니다(본사 자료)."
✅ A vs C 충돌 시 A급 우선: "공정위 21개점이지만 본사 측 최근 발표는 55호점 — 16개월 갭 가능성"
✅ C급 단독: "본사 자료 기준 가맹비는 5,000만원입니다."

❌ "국내 최고 / 1위 / 최저가" 등 무근거 수식어 차용 금지
❌ facts 외 본사 측 수치 인용 금지 (반드시 facts 의 raw value 만)
`
    : ""
}
# 시점 정직성
...
3. **## 출처 · 집계 방식** — 출처 + 기준월 + 갱신 주기 + 데이터 한계.
